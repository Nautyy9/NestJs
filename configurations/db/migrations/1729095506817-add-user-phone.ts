...
export class AddUserPhone1729095506817 implements MigrationInterface {
    name = 'AddUserPhone1729095506817'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "songs" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "releasedDate" date NOT NULL, "duration" TIME NOT NULL, "lyrics" text, CONSTRAINT "PK_e504ce8ad2e291d3a1d8f1ea2f4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "secret" text, "enable2FA" boolean NOT NULL DEFAULT false, "apiKey" text, "phone" text, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "playlists_songs" ("playlistsId" integer NOT NULL, "songsId" integer NOT NULL, CONSTRAINT "PK_64bfa1f885a85f3ac8018058218" PRIMARY KEY ("playlistsId", "songsId"))`);
